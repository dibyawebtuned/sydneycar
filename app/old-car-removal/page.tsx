          ...
          >
            ...
            >
              ...
              <p className={`text-green-900 text-[12px] leading-snug font-normal ${inter.className}`}>
                Old cars can leak oil, fuel, and other harmful materials over time. We make sure every vehicle we collect is safely dismantled and recycled through approved wrecking partners. Usable parts are salvaged, metals are recycled, and waste is disposed of responsibly — keeping Sydney cleaner and greener.
              </p>
            </motion.div>
          </motion.div>
        </div>
