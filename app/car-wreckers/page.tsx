    ...
    <div className="w-full bg-gray-50">
      ...
      <section className="relative bg-[#002043] text-white overflow-hidden min-h-screen xl:min-h-[90vh] sm:min-h-[60vh] flex items-center">
        <div className="absolute inset-0">
          ...
          <Image
            src="/scrat_images/WhatsApp Image 2025-08-25 at 1.34.17 PM.jpeg"
            alt="Car Wreckers"
            fill
          ...
          >
            ...
            >
              ...
              <p className={`text-green-900 text-[12px] leading-snug font-normal ${inter.className}`}>
                At Sydney Car Removal and Towing Services, we believe car wrecking should be clean and responsible. Usable parts are refurbished and resold, metals are recycled, and hazardous fluids are safely drained and processed. It’s a system that benefits both our customers and the environment.
              </p>
            </motion.div>
          </motion.div>
        </div>
