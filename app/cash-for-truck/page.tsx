    ...
    <div className="w-full bg-gray-50">
      ...
      <section className="relative bg-[#002043] text-white overflow-hidden min-h-screen xl:min-h-[90vh] sm:min-h-[60vh] flex items-center">
        <div className="absolute inset-0">
          ...
          <Image
            src="/scrat_images/WhatsApp Image 2025-08-25 at 1.34.16 PM (1).jpeg"
            alt="Cash for Truck"
            fill
          ...
          >
            ...
            >
              ...
              <p className={`text-green-900 text-[12px] leading-snug font-normal ${inter.className}`}>
                Every truck we buy is carefully dismantled and recycled in compliance with environmental standards. Usable parts are salvaged, metals are reused, and fluids are disposed of safely — keeping Sydney clean and sustainable.
              </p>
            </motion.div>
          </motion.div>
        </div>
