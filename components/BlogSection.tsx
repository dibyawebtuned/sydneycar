    ...
    >
      ...
      <div className="w-full sm:w-1/2 lg:w-3/5 p-6 sm:p-8 flex flex-col justify-center relative">
        ...
        <div className="mt-4 sm:mt-0 block">
          <h3
            className="text-2xl font-bold mb-2.5 leading-snug transition-colors duration-200 group-hover:text-[#044E9E] font-cabinet text-[#1e1e1e]"
          >
            {post.title}
          </h3>
          <p className={`text-[#6A6A6A] text-[14px] ${inter.className}`}>{post.description}</p>
          {/* <a
            href={post.link}
            className="inline-flex items-center text-sm font-semibold transition-colors duration-200 hover:text-gray-700 uppercase text-[#0c55a6]"
          >
            READ MORE
          </a> */}
        </div>
