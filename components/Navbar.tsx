        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:inline-flex lg:inline-flex">
            <button
              ...
              className={`inline-flex flex-wrap gap-2 items-center px-4 sm:px-6 py-2 border border-transparent text-sm sm:text-base font-medium shadow-lg text-white bg-[#0c55a6] hover:bg-[#094182] transition duration-200 transform hover:scale-[1.02] active:scale-[0.98] cursor-pointer ${inter.className}`}
            >
